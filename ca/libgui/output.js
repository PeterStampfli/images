...
output.createCanvas = function(gui, hasBackgroundColor = true, hasTransparency = true) {
    ...
    if (output.oddCanvasSize) {
        minValue = 1;
        stepValue = 2;
        output.canvas.width = 2 * Math.floor(output.canvas.width / 2) + 1;
        output.canvas.height = 2 * Math.floor(output.canvas.height / 2) + 1;
    } else {
        minValue = 2;
        stepValue = 1;
    }
 ...
 * coordinates go from center-range/2 to center+range/2
