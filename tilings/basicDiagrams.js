...
gui.add({
    ...
    params: tiling,
    property: 'initial',
    options: ['dodecagon', 'square', 'rhomb', 'triangle A', 'triangle B','triangle C'],
    onChange: function() {
        draw();
    }
});
...
function drawTriangleC() {
   ...
   canvasContext.stroke();
    ...
    canvasContext.moveTo(0,right);
    canvasContext.lineTo(rt32 * size, top - 0.5 * size);
    canvasContext.lineTo(rt32 * size, top - 1.5 * size);
    canvasContext.closePath();
    if (tiling.colors) {
        canvasContext.fill();
    }
   ...
   canvasContext.stroke();
    ...
    canvasContext.moveTo(size / 2, size / 2);
    canvasContext.lineTo(right, 0);
    canvasContext.lineTo(rt32*size,rt32*size);
    canvasContext.lineTo(0,right);
    canvasContext.closePath();
    if (tiling.colors) {
        canvasContext.fill();
