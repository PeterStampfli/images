...
gui.add({
    ...
    labelText: 'size',
    options: [initialSize/2,initialSize,2*initialSize,4*initialSize],
    onChange: function(size) {
        ...
        map.inputTransform.setPrescale(map.initialImageRegion * Math.min(map.inputCanvas.width/ map.rangeX, map.inputCanvas.height / map.rangeY));
