...
// the third circle
var r3, x3, y3;
var cosAlpha3, sinAlpha3, cosBeta3, sinBeta3, cosGamma3, sinGamma3; // the three sectors
...
function creation() {
    ...
    Button.createAction("mirror", function() {
        ...
        exchangeButtonValues(setM3Button, setN3Button);
        Make.updateNewMap();
    });
    ...
    inversionButton.onClick = function() {
        ...
        exchangeButtonValues(setMButton, setM3Button);
        exchangeButtonValues(setNButton, setN3Button);
        Make.updateNewMap();
    };
  ...
  */
    ...
    Make.initializeMap = function() {
        ...
        numbers13.innerHTML = "(" + infty(k1) + ", " + infty(m3) + ", " + infty(n3) + "),";
        numbers23.innerHTML = "(" + infty(m2) + ", " + infty(k3) + ", " + infty(m3) + "),";
        numbers33.innerHTML = "(" + infty(n2) + ", " + infty(n3) + ", " + infty(k3) + "),";
        sum13.innerHTML = "&nbsp " + triangleGeometry(k1, n3, m3);
        sum23.innerHTML = "&nbsp " + triangleGeometry(k3, m2, m3);
        sum33.innerHTML = "&nbsp " + triangleGeometry(k3, n2, n3);
        // same for all
        circleScope.reset();
